...
class NERTrainer:
    ...
    def _val_epoch(self,
                   ...
                   epoch_num: int):
        """
        Perform validation afterone training epoch
        """
    ...
    def _train(self,
        ...
        :param data_type: str, cnts.SOURCE or cnts.TARGET, data type which will be used for training
    ...
    def _eval(self,
        ...
        pred_extended, test_extended = self.prepare_preds_for_calc_metrics(pred_labels,
                                                                           test_labels,
                                                                           test_tokens)
        ...
        self.logger.info(f"Model has beed evaluated. Results saved to {results_path}")

    def prepare_preds_for_calc_metrics(self,
